...
widget_target = project.targets.find { |t| t.name == 'RingetWidgets' }
raise 'RingetWidgets target not found' unless widget_target
...
project.save
puts 'Set SWIFT_DEFAULT_ACTOR_ISOLATION on RingetWidgets.'

...
Status snapshot for picking this work back up. **Last updated 2026-09-19** (latest: **2026-09-19 Wobbly design refresh across every surface** at the bottom; before that: **2026-09-19 Hand-wobbled chart lines** at the bottom; before that **2026-09-19 Loading/empty mark: stronger wobble**; before that **2026-09-19 Live rings drawn hand-wobbled everywhere**; before that **2026-09-19 Empty states and placeholders match the new icon**; before that **2026-09-19 App icon redesign — wobbly two rings**; before that **2026-09-19 Docs sync** at the bottom; before that **2026-09-19 macOS: sheet titles flush-left**, at the bottom; before that **2026-09-19 macOS: menu bar dropdown trimmed, New Tracker name-field suggestions off**, at the bottom; before that **2026-09-19 watch rings: number and colour only**),

...
Status snapshot for picking this work back up. **Last updated 2026-09-19** (latest: **2026-09-19 App icon redesign — wobbly two rings** at the bottom; before that **2026-09-19 Docs sync** at the bottom; before that **2026-09-19 macOS: sheet titles flush-left**, at the bottom; before that **2026-09-19 macOS: menu bar dropdown trimmed, New Tracker name-field suggestions off**, at the bottom; before that **2026-09-19 watch rings: number and colour only**),
